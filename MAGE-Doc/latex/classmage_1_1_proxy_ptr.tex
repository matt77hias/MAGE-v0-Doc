...
Constructs a proxy pointer. \mbox{\Hypertarget{classmage_1_1_proxy_ptr_a72b18a0a5c86275ca4c033d7a975ff67}\label{classmage_1_1_proxy_ptr_a72b18a0a5c86275ca4c033d7a975ff67}} 
\index{mage\+::\+Proxy\+Ptr@{mage\+::\+Proxy\+Ptr}!Proxy\+Ptr@{Proxy\+Ptr}}
\index{Proxy\+Ptr@{Proxy\+Ptr}!mage\+::\+Proxy\+Ptr@{mage\+::\+Proxy\+Ptr}}
\subsubsection{\texorpdfstring{Proxy\+Ptr()}{ProxyPtr()}\hspace{0.1cm}{\footnotesize\ttfamily [3/8]}}
{\footnotesize\ttfamily template$<$typename T$>$ \\
template$<$typename ContainerT $>$ \\
\mbox{\hyperlink{classmage_1_1_proxy_ptr}{mage\+::\+Proxy\+Ptr}}$<$ T $>$\+::\mbox{\hyperlink{classmage_1_1_proxy_ptr}{Proxy\+Ptr}} (\begin{DoxyParamCaption}\item[{ContainerT \&}]{container,  }\item[{std\+::size\+\_\+t}]{index }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [explicit]}, {\ttfamily [noexcept]}}
