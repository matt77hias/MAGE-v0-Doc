...
{\footnotesize\ttfamily const std\+::regex mage\+::\+Line\+Reader\+::g\+\_\+default\+\_\+regex = std\+::regex(R\char`\"{}((\textbackslash{}\char`\"{}\mbox{[}$^\wedge$\textbackslash{}\char`\"{}\mbox{]}$\ast$\textbackslash{}\char`\"{})$\vert$\mbox{[}$^\wedge$\textbackslash{}n\textbackslash{}r\textbackslash{}s\textbackslash{}t\mbox{]}+)\char`\"{})\hspace{0.3cm}{\ttfamily [static]}}
