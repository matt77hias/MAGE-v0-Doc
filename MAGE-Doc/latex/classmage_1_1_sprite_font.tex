...
\item 
const R\+E\+CT \hyperlink{classmage_1_1_sprite_font_a7204248284cf5f158c16794f6c6fa253}{Measure\+Draw\+Bounds} (const vector$<$ \hyperlink{classmage_1_1_color_string}{Color\+String} $>$ \&text, const X\+M\+F\+L\+O\+A\+T2 \&position) const
\item 
...
{\footnotesize\ttfamily const R\+E\+CT mage\+::\+Sprite\+Font\+::\+Measure\+Draw\+Bounds (\begin{DoxyParamCaption}\item[{const vector$<$ \hyperlink{classmage_1_1_color_string}{Color\+String} $>$ \&}]{text,  }\item[{const X\+M\+F\+L\+O\+A\+T2 \&}]{position }\end{DoxyParamCaption}) const}
